...
RUNTIME_SOURCES := $(CORE_SOURCES) src/api.c src/exception.c src/gc.c src/value_ops.c src/pbc.c src/state.c src/vm.c stdlib/builtins.c stdlib/strings.c stdlib/arrays.c stdlib/formatting.c stdlib/json.c stdlib/system.c stdlib/files.c hal/posix/hal_posix.c
