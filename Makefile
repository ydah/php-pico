...
RUNTIME_SOURCES := $(CORE_SOURCES) src/exception.c src/value_ops.c src/pbc.c src/state.c src/vm.c stdlib/builtins.c stdlib/strings.c stdlib/arrays.c stdlib/formatting.c
