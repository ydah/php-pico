...
- Added the C99 PHP subset compiler, PPBC v2 loader/writer, stack VM, classes,
...
- Added the RP2040 HAL, USB CDC/UART console, littlefs flash storage, serial
  upload/test tooling, automatic boot files, and BOOTSEL/Ctrl-C recovery.
- Added strict PPBC target-configuration checks and ROM size regression gates.

| Runtime release | PPBC format |
|---|---:|
| 1.0.x | 2 |
